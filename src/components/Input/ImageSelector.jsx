...
const ImageSelector = ({image,setImage, handleDeletImg}) => {
        ...
        <div>
            ...
            {previewUrl ? (
                    <div className="w-full relative">
                        ...
                        <button 
                         className="w-full h-[220px] flex flex-col items-center gap-4 bg-slate-50 rounded border border-slate-200/50" 
